...
func (i *addFunc) ReduceExpr(me driverbottom.Token, before []driverbottom.Expr, after []driverbottom.Expr) (driverbottom.Expr, bool) {
	if len(before) != 1 {
	...
	return &addExpr{binop: binop{Locatable: me, opname: "add", lhs: before[0], rhs: after[0]}}, true
}
